...
const Wallet = () => {
  ...
  const tokens: IToken[] = [
    ...
    },
    {
      ...
      tokenName: "ATERRA",
      count: "1268991.41",
      balanceInDollar: "1 336.71",
      balanceInCrypto: "216.64",
      bonusPercent: "110.00",
    },
    {
      avatar: tokenAvatarThree,
      tokenName: "DHD",
      count: "0.00",
      balanceInDollar: "0.00",
      balanceInCrypto: "0.00",
    ...
    {
      avatar: tokenAvatarFour,
      tokenName: "MIC",
      count: "200.00",
      balanceInDollar: "3.47",
      balanceInCrypto: "0.56",
      bonusPercent: "0.62",
    },
  ];
  ...
  return (
    <div className={style["wallet-page"]}>
      <Header text="кошелёк" subtitle="UQCWJZWPTIQOZ" />
      ...
      <div className={style["def-buttons"]}>
        ...
        <Button onClick={() => {}}>
          <div className={style["children"]}>
            ...
            <div>Отключить кошелёк</div>
          </div>
        </Button>
      </div>
      {withdrawPopup && (
        <WithdrawPopup closePopup={() => setWithdrawPopup(false)} />
      )}
    </div>
  );
};
